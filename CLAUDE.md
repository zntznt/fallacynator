...
- Run all four test suites (`engine`, `checklist`, `coverage`, `calibration`) before committing. All must pass.
...
- `mascot/`: hand-made raster art drops here (see `mascot/README.md`). The mascot is optional and the app never depends on it.
